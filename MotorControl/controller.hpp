...
public:
    ...
    enum InputMode
    {
        ...
        INPUT_MODE_TORQUE_RAMP = 4,
        // INPUT_MODE_MIX_CHANNELS = 5,
        // INPUT_MODE_TRAP_TRAJ = 6,
        // INPUT_MODE_MIRROR = 7,
        // INPUT_MODE_TUNING = 8,
    };
    ...
    struct Config_t
    {
        ...
        // // custom setters
        // Controller *parent;
        // void set_input_filter_bandwidth(float value)
        // {
        //     input_filter_bandwidth = value;
        //     parent->update_filter_gains();
        // }
        // void set_steps_per_circular_range(uint32_t value) { steps_per_circular_range = value > 0 ? value : steps_per_circular_range; }
        // void set_control_mode(ControlMode value)
        // {
        //     control_mode = value;
        //     parent->control_mode_updated();
        // }
    };
